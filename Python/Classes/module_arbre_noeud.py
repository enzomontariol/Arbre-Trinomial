...
if __name__ == "__main__" : 
    ...
    barriere = Barriere(110, type_barriere=TypeBarriere.knock_out, direction_barriere=DirectionBarriere.up)
    
    option = Option(maturite = expiry, prix_exercice = strike, barriere=barriere, call = True, date_pricing = today, americaine=False)
